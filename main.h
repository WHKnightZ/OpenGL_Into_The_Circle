...
float Game_Alpha;
Goal *Goal_Current, *Goal_Last, *Goal_Ptr, *Goal_Stand;
Image Img_Logo, Img_Start_Btn, Img_Start, Img_Start_Center;
Image Img_Ball, Img_Goal, Img_Goal_Cover;
...
Rect Rct_Perfect, Rct_Perfect_Save[80];
int Is_Perfect, Perfect_Stt;
float Perfect_Alpha[80];

int Score, Score_Add, Score_Array[3], Score_Length;
float Score_Start;
...
Mix_Chunk *Sound_Goal = NULL;
Mix_Chunk *Sound_Dead = NULL;
Mix_Chunk *Sound_Perfect = NULL;
